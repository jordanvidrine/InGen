...
async function build(path) {
  try {
    let sections = await getSectionContent(path);
    let page = await getPageContent(path);
    ...
    await fsPromises.copyFile(`./templates/css/${page.options.style}.css`, `_test-site/assets/css/${page.options.style}.css`)
  } catch(e) {
    console.log(e)
  }
